...
const InsuranceForm = () => {
  const [insurance, setInsurance] = useState<Insurance>({
    ...
    photoUrl: "",
    documents: [{ name: "", url: "" }],
    types: [{ name: "", price: 0, duration: "", coverage: "" }],
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post("/insurance/create-insurance", insurance); // Replace with your actual API endpoint
      setMessage("Insurance created successfully!");
    } catch (err) {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white shadow-md rounded-md">
      <h2 className="text-2xl font-bold mb-6 text-center">Create Insurance</h2>
